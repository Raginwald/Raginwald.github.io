<template>
    <v-row id="front-back">
        ...
        <v-col id="front-side" class="text-center">
            <h1>CLIENT</h1>
        ...
        <v-col id="back-side" class="text-center">
            <h1>SERVEUR</h1>
            <h3>Le serveur représente la machine qui héberge les pages du site visité</h3>

            <v-row class="server">
                <v-col cols="4" class="server-element apache" :class="serverColorCircle(3, 10)">
                    <v-tooltip left>
                ...
                <v-col cols="4" class="server-element php" :class="serverColorCircle(5, 9)">
                    <v-tooltip left>
                        <template v-slot:activator="{ on, attrs }">
                ...
                <v-col cols="4" class="server-element database" :class="serverColorCircle(7, 8)">
                    <v-tooltip left>
                        <template v-slot:activator="{ on, attrs }">
